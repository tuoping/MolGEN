...
def parse_train_args():
    ...
    group.add_argument("--integration-type", type=str, default="ODE", choices=["ODE", "SDE"])
    group.add_argument("--KL", type=str, default="L2", choices=['forward', 'reverse', 'symm', "L2", 'L1'])
    ...
    if args.path_type == "Schrodinger_Linear":
        args.integration_type = "SDE"
    if args.prediction == "velocity":
        args.integration_type = "ODE"
