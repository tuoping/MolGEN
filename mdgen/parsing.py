...
def parse_train_args():
    ...
    group.add_argument('--pref_loss_consistency', type=float, default=1.0)
    ...
    group.add_argument("--likelihood", type=str, default=None, choices = ["None", "EJE", "FND"])
    ...
    group.add_argument('--k-spring', type=float, default=1)
