...
# node_irreps = f"32x0e"     # 16 scalar channels + 8 vector channels per node
# msg_irreps  = "64x0e + 16x1o"     # edge message type (you can change)
node_irreps = [(32, (0, +1))]                 # 32x0e
msg_irreps  = [(64, (0, +1)), (16, (1, -1))]  # 64x0e + 16x1o

edge_block = EdgeCGBlock(node_irreps, msg_irreps, lmax=2, num_rbf=96, cutoff=model.model.cutoff)
...
edge_attr_r = edge_block(f0, edge_index, edge_vec)  
